    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        ...
        >
          ...
          <p className="text-dark-400 mb-8">Continue your study abroad journey</p>
      ...
      {/* Right Panel - Visual */}
      <div className="hidden lg:flex flex-1 items-center justify-center bg-gradient-to-br from-primary-900/50 to-dark-950 p-12">
        <motion.div
        ...
        >
          ...
          <h2 className="text-3xl font-bold mb-4">
            Your AI Counselor Awaits
          </h2>
          <p className="text-dark-400">
            Pick up where you left off. Your personalized university recommendations and 
            application tasks are ready for you.
          </p>

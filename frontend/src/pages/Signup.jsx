    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex flex-1 items-center justify-center bg-gradient-to-br from-accent-900/30 to-dark-950 p-12">
        ...
        >
          ...
          <p className="text-dark-400 mb-12">
            Join thousands of students who are using AI to find their perfect university match.
          </p>
          ...
          >
            <p className="text-dark-300 italic mb-4">
              "StudyPath AI helped me find universities I never knew existed. The AI counselor 
              understood exactly what I was looking for."
            </p>
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-gradient-to-br from-primary-500 to-accent-500 rounded-full" />
              <div>
                <div className="font-medium">Priya Sharma</div>
                <div className="text-sm text-dark-500">MS Computer Science, Stanford</div>
              </div>
            </div>
          </motion.div>
        </motion.div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        ...
        >
          ...
          <p className="text-dark-400 mb-8">Start planning your study abroad journey today</p>
